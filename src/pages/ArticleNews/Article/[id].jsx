...
export default function Article() {
  ...
  return (
    <>
        ...
        <div className="navbar bg-opacity-0 bg-transparent z-50 w-[1128px] mt-[31px]">
          <div className="header flex items-center justify-between text-black">
            <div className="logo flex items-center font-bold text-2xl cursor-pointer">
              <Image className="mr-[19px]" src="/img/logoBlack.png" alt="" />
              <h1>LAYANG</h1>
            </div>
      ...
      <div>
        <div className="flex flex-col items-center text-justify mt-[69px] mb-[80px]">
          <div className="w-[744px]">
            ...
            <h1 className="text-[44px] font-bold mb-[27px] text-left text-[#27005D]">{title}</h1>
          ...
          <div className="w-[1128px]">
            <div className="container font-Poppins pt-[100px] rounded-t-[30px] mt-[-25px]">
              <div className="pr-64">
                ...
                <p className="text-white opacity-30 w-[360px] my-[24px]"></p>
              </div>
              <div className="flex gap-[32px]">
                <a href="">
                  <Image src="img/logo-facebook.png" alt="" />
                </a>
                <a href="">
                  <Image src="img/logo-twitter.png" alt="" />
                </a>
                <a href="">
                  <Image src="img/logo-instagram.png" alt="" />
                </a>
                <a href="">
                  <Image src="img/logo-github.png" alt="" />
                </a>
              </div>
